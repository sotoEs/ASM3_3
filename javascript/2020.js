  ...
  yAxis: [
    {
      ...
      data: ['Enero', 'Febrer', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio','Agosto','Septiembre','Octubre', 'Noviembre', 'Diciembre']
    }
  ],
  series: [
    
    {
      ...
      data: [117, 124, 117, 113, 101, 91, 89, 87, 98, 88, 110, 81]
    },
    {
...
// Crea un array de tonos que corresponda a cada mes
const tonos = [117, 124, 117, 113, 101, 91, 89, 87, 98, 88, 110, 81];
